...
DAY_TYPE_BY_TIER: dict[str, dict[str, int]] = {
    ...
    # 2026-06-18 (owner): fixed per-day truth — a CF or Z2 day is ~1,075
    # active burn, a rest day ~600. 3 CF + 1 Z2 + 3 rest = 6,100/wk. The
    # GOAL drives pace FEEDBACK (behind/ahead + make-up suggestions), it no
    # longer rescales these per-day ideals (that produced the 1,225/1,350/550
    # nonsense). See replan_week's rescale gate (commitment-only).
    "hammer":      {"cf": 1075, "z2": 1075, "rest": 600},
}
