...
# Load .env once at import — but NOT under RAHAT_TEST_MODE, so the suite is
# hermetic: the production .env can't leak vars (e.g. RAHAT_INTENT_LAYER=1)
# into pytest and skew routing/flag-gated behavior. Round-2 P2-2.
import os as _os
if not _os.getenv("RAHAT_TEST_MODE"):
    load_dotenv()
