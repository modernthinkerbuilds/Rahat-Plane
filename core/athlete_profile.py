...
required:
  ...
  - Mobility constraints ("The Hunch", tight hamstrings, ankle stiffness,
    neck/trap tension that triggers headaches)
  - Health constraints (borderline high blood pressure)
...
USAGE:
    ...
    print(profile.bp_status)                 # 'borderline_high'
...
_DEFAULT = AthleteProfile(
    ...
    health_flags=[
        HealthFlag(
            name="borderline_high_bp",
            description=(
                "Borderline high blood pressure (not on medication)."
            ),
            coaching_rule=(
    ...
    mobility_constraints=[
        ...
        MobilityConstraint(
            name="neck_traps",
            description=(
                "Tension builds quickly in neck/traps during runs and "
                "high-rep pulling; can trigger tension headaches."
            ),
            coaching_rule=(
