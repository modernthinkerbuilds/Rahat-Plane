...
Constraint from the athlete:
  the athlete may report transient pain; beyond that, assume only the
  standing health/mobility flags already on file.
...
USAGE:
    ...
    # User reports pain:
    pain_state.report("<location>", severity="mild", ttl_hours=48)
    pain_state.report("<location>", severity="moderate", ttl_hours=72)
...
class PainReport:
    ...
    location: str       # free-text body location, e.g. '<side> <joint>'
