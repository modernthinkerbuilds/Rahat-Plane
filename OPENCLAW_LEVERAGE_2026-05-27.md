...
- **OpenClaw is an external open-source project Rahat uses, not a Alex
  project.** `specs/MODEL-FIRST-PIVOT.md` (2026-05-08) called it "a related
  Alex project" — that phrase was ambiguous and earlier Claude sessions
  read it as ownership. **Corrected 2026-05-30: Alex did not build OpenClaw;
  ...
  OpenClaw (which Rahat depends on), not by Alex-as-OpenClaw-creator.
