...
def test_orchestrator_native_path_smoke():
    ...
    # 2026-06-14: "what is my plan today" now delegates to kobe_route, whose
    # used_tools is ['kobe_route'] (no orchestrator charter tool). Switched
    # to an open-coaching message that orchestrates, so the native
    # end-to-end orchestrate flow (which always runs kobe_charter_check)
    # stays under test.
